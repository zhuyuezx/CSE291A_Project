...
combinations of LLM-optimized TextWorld heuristics on the held-out test set.
"""
...
def main() -> None:
    ...
    print(
        f"{'Configuration':<30} "
        f"{'Train Correct':>16} {'Train Δ':>9} {'Train Ret':>11} {'Train Steps':>12} "
        f"{'Test Correct':>16} {'Test Δ':>9} {'Test Ret':>10} {'Test Steps':>11}"
    )
    print("-" * 136)
    print(
        f"{'baseline':<30} "
