...
DESCRIPTION: Added depth‑discounted rewards, a stronger solved‑state bonus based on remaining steps, and kept a tiny epsilon boost to keep solved leaves dominant.
```python
def default_backpropagation(node, reward: float) -> None:
    """
