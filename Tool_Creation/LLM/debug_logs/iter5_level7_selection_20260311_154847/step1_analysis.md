...
| Field      | Value |
|------------|-------|
| Timestamp  | 2026-03-11 15:49:01 |
| Model      | api-gpt-oss-120b |
| Elapsed    | 13.16s |
| Status     | success |
| Tokens     | 14007 |
| Validation | invalid — SyntaxError: unexpected indent (<unknown>, line 3) |
...
Timestamp:  2026-03-11T15:48:47.850285
Iterations: 500
Solved:     False
Steps:      3
Returns:    [0.0]
  ...
  Move 2: action=((2, 4), 2), total_visits=500
    ...
    Children: []
  Move 3: action=((1, 2), 1), total_visits=500
    State: Step 3/1000 | Boxes on target: 0/3 | Total distance: 5
    Children: []

Final state:
Step 6/1000 | Boxes on target: 0/3 | Total distance: 6
 ########
 # .$. .#
 #@  #$ #
 #$     #
