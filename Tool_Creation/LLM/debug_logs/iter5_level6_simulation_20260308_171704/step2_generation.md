...
DESCRIPTION: Fixed wall‑line dead‑lock test, reduced push penalty, added push bonus, tightened distance normalisation, and ensured pushes are selected when heuristic ties – all to make roll‑outs favour useful pushes.
```python
import random
import math
import itertools
