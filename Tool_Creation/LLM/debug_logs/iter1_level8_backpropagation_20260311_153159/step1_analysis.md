...
Timestamp:  2026-03-11T15:31:59.068928
Iterations: 500
Solved:     False
Steps:      6
Returns:    [0.0]
  ...
  Move 1: action=((4, 4), 0), total_visits=500
    ...
    Children: [((4, 4), 0)(v=497, avg=0.436), ((3, 2), 0)(v=1, avg=0.000), ((2, 4), 1)(v=1, avg=0.000), ((1, 2), 1)(v=1, avg=0.056)]
  Move 2: action=((3, 4), 0), total_visits=500
    State: Step 1/1000 | Boxes on target: 0/4 | Total distance: 6
    Children: [((3, 4), 0)(v=495, avg=0.441), ((3, 2), 0)(v=1, avg=0.000), ((3, 4), 2)(v=1, avg=0.108), ((3, 2), 3)(v=1, avg=0.093), ((1, 4), 1)(v=1, avg=0.080), ((1, 2), 1)(v=1, avg=0.066)]
  Move 3: action=((3, 2), 0), total_visits=500
    State: Step 2/1000 | Boxes on target: 1/4 | Total distance: 5
    Children: [((1, 5), 2)(v=1, avg=0.274), ((3, 2), 0)(v=495, avg=0.443), ((3, 4), 2)(v=1, avg=0.264), ((3, 2), 3)(v=1, avg=0.253), ((1, 3), 3)(v=1, avg=0.218), ((1, 2), 1)(v=1, avg=0.208)]
  Move 4: action=((1, 1), 3), total_visits=500
    State: Step 8/1000 | Boxes on target: 1/4 | Total distance: 4
    Children: [((1, 1), 3)(v=495, avg=0.448), ((2, 2), 3)(v=1, avg=0.000), ((3, 2), 3)(v=1, avg=0.000), ((3, 4), 2)(v=1, avg=0.000), ((1, 5), 2)(v=1, avg=0.000), ((2, 4), 2)(v=1, avg=0.000)]
  Move 5: action=((3, 2), 3), total_visits=500
    State: Step 11/1000 | Boxes on target: 2/4 | Total distance: 3
    Children: [((2, 2), 3)(v=3, avg=0.284), ((3, 2), 3)(v=495, avg=0.450), ((3, 4), 2)(v=1, avg=0.363), ((2, 4), 2)(v=1, avg=0.356)]
  Move 6: action=((4, 4), 0), total_visits=500
    State: Step 14/1000 | Boxes on target: 2/4 | Total distance: 3
    Children: [((3, 3), 3)(v=1, avg=0.415), ((4, 4), 0)(v=495, avg=0.451), ((2, 2), 3)(v=1, avg=0.401), ((3, 5), 2)(v=1, avg=0.387), ((2, 4), 1)(v=1, avg=0.000), ((2, 4), 2)(v=1, avg=0.342)]

Final state:
Step 17/1000 | Boxes on target: 2/4 | Total distance: 2
########
#  **..#
#  $$  #
#   @  #
