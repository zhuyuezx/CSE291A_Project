...
DESCRIPTION: Enriched heuristic with player walk cost, added cheap corner‑deadlock filter, relaxed visited pruning, and tie‑break on walk distance to improve ordering and reduce over‑pruning.
```python
"""
A*-guided MCTS expansion.
