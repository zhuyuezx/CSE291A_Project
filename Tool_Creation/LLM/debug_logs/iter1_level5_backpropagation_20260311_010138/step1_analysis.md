...
Timestamp:  2026-03-11T01:01:38.488637
Iterations: 500
Solved:     True
Steps:      7
Returns:    [1.0]
  ...
  Move 1: action=((3, 5), 2), total_visits=500
    ...
    Children: [((3, 5), 2)(v=497, avg=0.962), ((1, 3), 1)(v=1, avg=0.286), ((3, 3), 0)(v=1, avg=0.250), ((3, 3), 3)(v=1, avg=0.250)]
  Move 2: action=((3, 4), 2), total_visits=500
    State: Step 1/1000 | Boxes on target: 0/3 | Total distance: 4
    Children: [((3, 4), 2)(v=497, avg=0.967), ((1, 4), 1)(v=1, avg=0.333), ((3, 2), 3)(v=1, avg=0.286), ((3, 4), 0)(v=1, avg=0.286)]
  Move 3: action=((1, 3), 1), total_visits=500
    State: Step 2/1000 | Boxes on target: 1/3 | Total distance: 3
    Children: [((1, 3), 1)(v=484, avg=0.983), ((1, 4), 1)(v=10, avg=0.565), ((2, 2), 1)(v=1, avg=0.563), ((4, 2), 0)(v=1, avg=0.571), ((3, 1), 3)(v=1, avg=0.333), ((3, 3), 0)(v=1, avg=0.500), ((3, 3), 2)(v=1, avg=0.328), ((3, 4), 0)(v=1, avg=0.500)]
  Move 4: action=((2, 5), 2), total_visits=500
    State: Step 9/1000 | Boxes on target: 1/3 | Total distance: 3
    Children: [((2, 5), 2)(v=493, avg=0.990), ((1, 4), 1)(v=1, avg=0.571), ((2, 2), 1)(v=1, avg=0.571), ((2, 3), 1)(v=1, avg=0.571), ((4, 2), 0)(v=1, avg=0.571), ((4, 3), 0)(v=1, avg=0.571), ((2, 3), 3)(v=1, avg=0.500), ((3, 4), 0)(v=1, avg=0.494)]
  Move 5: action=((2, 4), 2), total_visits=500
    State: Step 14/1000 | Boxes on target: 1/3 | Total distance: 2
    Children: [((2, 4), 2)(v=497, avg=0.992), ((2, 2), 1)(v=1, avg=0.667), ((4, 2), 0)(v=1, avg=0.667), ((2, 2), 3)(v=1, avg=0.571)]
  Move 6: action=((2, 3), 1), total_visits=500
    State: Step 15/1000 | Boxes on target: 2/3 | Total distance: 1
    Children: [((2, 3), 1)(v=494, avg=0.997), ((4, 3), 0)(v=4, avg=0.735), ((2, 1), 3)(v=1, avg=0.667), ((2, 3), 2)(v=1, avg=0.667)]
  Move 7: action=((4, 4), 2), total_visits=500
    State: Step 16/1000 | Boxes on target: 2/3 | Total distance: 1
    Children: [((4, 4), 2)(v=495, avg=1.000), ((2, 1), 3)(v=1, avg=0.667), ((2, 3), 2)(v=1, avg=0.667), ((3, 1), 3)(v=1, avg=0.667), ((3, 3), 2)(v=1, avg=0.667), ((4, 2), 3)(v=1, avg=0.750)]
