...
Timestamp:  2026-03-11T15:29:02.369087
Iterations: 500
Solved:     False
Steps:      4
Returns:    [0.0]
  ...
  Move 1: action=((3, 3), 0), total_visits=500
    ...
    Children: [((3, 4), 0)(v=1, avg=0.126), ((3, 3), 0)(v=497, avg=0.214), ((1, 3), 1)(v=1, avg=0.048), ((1, 4), 1)(v=1, avg=0.044)]
  Move 2: action=((3, 4), 0), total_visits=500
    State: Step 3/1000 | Boxes on target: 1/3 | Total distance: 4
    Children: [((3, 4), 0)(v=499, avg=0.214), ((1, 2), 3)(v=1, avg=0.075)]
...
Aggregate best (avg across 8 levels): 0.5000
...
Active levels (not yet mastered): ['level10', 'level4', 'level6', 'level7', 'level8', 'level9']
Mastered levels: ['level1', 'level2', 'level3', 'level5']
...
Recent iterations:
  ...
  Iter 7 [level9] [backpropagation]: composite=0.0000, solve_rate=0%, desc= ✗ rejected
  Iter 8 [level3] [simulation]: composite=1.0000, solve_rate=100%, desc=n/a ✗ rejected
