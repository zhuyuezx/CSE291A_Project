...
Timestamp:  2026-03-11T00:39:47.323660
Iterations: 500
Solved:     False
Steps:      5
Returns:    [0.0]
  ...
  Move 1: action=((3, 4), 0), total_visits=500
    ...
    Children: [((3, 4), 0)(v=229, avg=0.000), ((3, 6), 0)(v=167, avg=0.000), ((3, 3), 0)(v=104, avg=0.000)]
  Move 2: action=((3, 6), 0), total_visits=500
    State: Step 2/1000 | Boxes on target: 0/3 | Total distance: 4
    Children: [((3, 3), 0)(v=1, avg=0.036), ((3, 6), 0)(v=497, avg=0.000), ((1, 3), 3)(v=1, avg=0.065), ((1, 5), 2)(v=1, avg=0.064)]
  Move 3: action=((1, 3), 3), total_visits=500
    State: Step 6/1000 | Boxes on target: 0/3 | Total distance: 3
    Children: [((1, 7), 2)(v=97, avg=0.000), ((3, 3), 0)(v=95, avg=0.000), ((1, 3), 3)(v=308, avg=0.000)]
  Move 4: action=((3, 3), 0), total_visits=500
    State: Step 15/1000 | Boxes on target: 1/3 | Total distance: 2
    Children: [((3, 3), 0)(v=500, avg=0.000)]
  Move 5: action=((1, 2), 3), total_visits=500
    State: Step 19/1000 | Boxes on target: 2/3 | Total distance: 1
    Children: []

Final state:
Step 22/1000 | Boxes on target: 1/3 | Total distance: 2
 ########
 # +$*$.#
 #   #  #
 #      #
