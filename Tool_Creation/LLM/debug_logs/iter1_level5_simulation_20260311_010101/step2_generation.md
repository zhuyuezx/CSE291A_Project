...
DESCRIPTION: Enriched the leaf‑evaluation heuristic with (1) player walk‑cost estimate, (2) progress bias from boxes already on targets, and (3) a gentler scaling to keep reward differences visible for larger distances.
```python
from __future__ import annotations
