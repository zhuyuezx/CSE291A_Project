...
Timestamp:  2026-03-11T00:44:10.822288
Iterations: 500
Solved:     True
Steps:      7
Returns:    [1.0]
  ...
  Move 1: action=((3, 5), 2), total_visits=500
    ...
    Children: [((3, 5), 2)(v=497, avg=0.002), ((1, 3), 1)(v=1, avg=0.037), ((3, 3), 0)(v=1, avg=0.027), ((3, 3), 3)(v=1, avg=0.027)]
  Move 2: action=((3, 4), 2), total_visits=500
    State: Step 1/1000 | Boxes on target: 0/3 | Total distance: 4
    Children: [((3, 4), 2)(v=497, avg=0.002), ((1, 4), 1)(v=1, avg=0.050), ((3, 2), 3)(v=1, avg=0.037), ((3, 4), 0)(v=1, avg=0.037)]
  Move 3: action=((1, 3), 1), total_visits=500
    State: Step 2/1000 | Boxes on target: 1/3 | Total distance: 3
    Children: [((1, 3), 1)(v=457, avg=0.002), ((1, 4), 1)(v=37, avg=0.002), ((2, 2), 1)(v=1, avg=0.058), ((4, 2), 0)(v=1, avg=0.067), ((3, 1), 3)(v=1, avg=0.050), ((3, 3), 0)(v=1, avg=0.050), ((3, 3), 2)(v=1, avg=0.043), ((3, 4), 0)(v=1, avg=0.050)]
  Move 4: action=((2, 5), 2), total_visits=500
    State: Step 9/1000 | Boxes on target: 1/3 | Total distance: 3
    Children: [((2, 5), 2)(v=493, avg=0.002), ((1, 4), 1)(v=1, avg=0.067), ((2, 2), 1)(v=1, avg=0.067), ((2, 3), 1)(v=1, avg=0.067), ((4, 2), 0)(v=1, avg=0.067), ((4, 3), 0)(v=1, avg=0.067), ((2, 3), 3)(v=1, avg=0.050), ((3, 4), 0)(v=1, avg=0.043)]
  Move 5: action=((2, 4), 2), total_visits=500
    State: Step 14/1000 | Boxes on target: 1/3 | Total distance: 2
    Children: [((2, 4), 2)(v=497, avg=0.002), ((2, 2), 1)(v=1, avg=0.091), ((4, 2), 0)(v=1, avg=0.091), ((2, 2), 3)(v=1, avg=0.067)]
  Move 6: action=((2, 3), 1), total_visits=500
    State: Step 15/1000 | Boxes on target: 2/3 | Total distance: 1
    Children: [((2, 3), 1)(v=459, avg=0.002), ((4, 3), 0)(v=39, avg=0.002), ((2, 1), 3)(v=1, avg=0.091), ((2, 3), 2)(v=1, avg=0.091)]
  Move 7: action=((4, 4), 2), total_visits=500
    State: Step 16/1000 | Boxes on target: 2/3 | Total distance: 1
    Children: [((4, 4), 2)(v=495, avg=0.002), ((2, 1), 3)(v=1, avg=0.091), ((2, 3), 2)(v=1, avg=0.091), ((3, 1), 3)(v=1, avg=0.091), ((3, 3), 2)(v=1, avg=0.091), ((4, 2), 3)(v=1, avg=0.091)]
