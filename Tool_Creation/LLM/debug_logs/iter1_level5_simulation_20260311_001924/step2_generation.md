...
DESCRIPTION: Added dead‑lock penalty, incorporated walk‑step count (state.steps) and box‑distance into a blended cost, and switched to an exponential shaping function for a richer gradient.
```python
"""
