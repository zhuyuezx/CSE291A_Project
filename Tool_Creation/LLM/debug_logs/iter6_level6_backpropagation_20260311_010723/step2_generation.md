...
DESCRIPTION: Strengthened depth discount, added step‑cost penalty, and increased solved bonus to make shallow, low‑step solutions dominate back‑propagation values.
```python
def default_backpropagation(node, reward: float) -> None:
    """
