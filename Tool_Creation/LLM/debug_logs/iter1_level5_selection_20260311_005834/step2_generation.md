...
DESCRIPTION: Added UCB‑style exploration term, deadlock penalty, and visit‑based tie‑break while keeping A*‑guided g+h scoring; also safeguards against zero‑visit division.
```python
"""
