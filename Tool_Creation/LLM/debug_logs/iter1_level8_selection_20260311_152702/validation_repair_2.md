...
**FILE_NAME:** selection.py  
**FUNCTION_NAME:** default_selection  
**DESCRIPTION:** Fixed validation errors by adding required metadata fields and ensuring the function signature uses the required `root` parameter.
