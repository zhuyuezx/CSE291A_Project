...
DESCRIPTION: Added explicit push‑value based on Manhattan improvement, scaled push‑bonus, penalty for worsening moves, re‑weighted distance terms, and ensured ε ≥ 0.2 when pushes are available to make pushes attractive during roll‑outs.
```python
import random
import math
import itertools
