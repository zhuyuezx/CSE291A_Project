...
Active levels (not yet mastered): ['level1', 'level10', 'level2', 'level3', 'level6', 'level7', 'level9']
Mastered levels: ['level4', 'level5', 'level8']
...
Recent iterations:
  Iter 1 [level5] [backpropagation]: composite=1.0000, solve_rate=100%, eval_time=0.2s, desc=No changes needed; the draft implementation is correct and efficient. ★ BEST-for-level
  Iter 2 [level8] [expansion]: composite=1.0000, solve_rate=100%, desc=n/a ✗ rejected
  Iter 3 [level4] [expansion]: composite=1.0000, solve_rate=100%, desc=n/a ✗ rejected
...
DESCRIPTION: Relaxed monotonicity pruning, accounted for accumulated walk cost, added reachable‑box penalty to heuristic, and introduced simple wall‑line dead‑lock detection for better expansion decisions.
```python
"""
