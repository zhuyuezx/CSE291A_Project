...
Timestamp:  2026-03-11T15:27:21.320091
Iterations: 500
Solved:     False
Steps:      7
Returns:    [0.0]
  ...
  Move 1: action=((2, 3), 2), total_visits=500
    ...
    Children: [((2, 3), 2)(v=481, avg=0.141), ((2, 3), 3)(v=13, avg=0.034), ((2, 1), 3)(v=1, avg=0.033), ((2, 5), 2)(v=1, avg=0.033), ((4, 1), 3)(v=1, avg=0.019), ((4, 3), 2)(v=1, avg=0.009), ((4, 3), 3)(v=1, avg=0.009), ((4, 5), 2)(v=1, avg=0.019)]
  Move 2: action=((2, 3), 3), total_visits=500
    State: Step 1/1000 | Boxes on target: 0/4 | Total distance: 7
    Children: [((2, 3), 3)(v=493, avg=0.143), ((1, 1), 1)(v=1, avg=0.050), ((2, 5), 2)(v=1, avg=0.029), ((4, 3), 2)(v=1, avg=0.008), ((4, 3), 3)(v=1, avg=0.008), ((4, 5), 2)(v=1, avg=0.012), ((3, 1), 0)(v=1, avg=0.055), ((4, 1), 3)(v=1, avg=0.000)]
  Move 3: action=((1, 5), 1), total_visits=500
    State: Step 3/1000 | Boxes on target: 0/4 | Total distance: 6
    Children: [((1, 5), 1)(v=499, avg=0.143), ((1, 1), 1)(v=1, avg=0.032)]
  Move 4: action=((2, 5), 1), total_visits=500
    State: Step 6/1000 | Boxes on target: 0/4 | Total distance: 7
    Children: [((2, 5), 1)(v=499, avg=0.144), ((1, 1), 1)(v=1, avg=0.000)]
  Move 5: action=((3, 5), 1), total_visits=500
    State: Step 7/1000 | Boxes on target: 0/4 | Total distance: 6
    Children: [((3, 5), 1)(v=499, avg=0.144), ((1, 1), 1)(v=1, avg=0.000)]
  Move 6: action=((4, 5), 2), total_visits=500
    State: Step 8/1000 | Boxes on target: 1/4 | Total distance: 5
    Children: [((4, 5), 2)(v=499, avg=0.144), ((1, 1), 1)(v=1, avg=0.058)]
  Move 7: action=((3, 1), 0), total_visits=500
    State: Step 9/1000 | Boxes on target: 1/4 | Total distance: 6
    Children: [((3, 1), 0)(v=499, avg=0.145), ((1, 1), 1)(v=1, avg=0.032)]

Final state:
Step 16/1000 | Boxes on target: 2/4 | Total distance: 5
#######
#*   .#
#@    #
# ### #
...
Baseline for level10 (default MCTS): composite=0.0000, solve_rate=0%, avg_returns=0.0000
Aggregate best (avg across 3 levels): 0.6667
...
Active levels (not yet mastered): ['level1', 'level10', 'level3', 'level4', 'level6', 'level7', 'level8', 'level9']
Mastered levels: ['level2', 'level5']
...
Recent iterations:
  Iter 1 [level2] [backpropagation]: composite=1.0000, solve_rate=100%, desc=n/a ✗ rejected
  Iter 2 [level10] [selection]: composite=0.0000, solve_rate=0%, desc= ✗ rejected
  Iter 2 [level10] [expansion]: composite=0.0000, solve_rate=0%, desc= ✗ rejected
