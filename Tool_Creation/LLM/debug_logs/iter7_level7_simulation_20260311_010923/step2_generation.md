...
DESCRIPTION: Added progress bonus, step‑cost penalty, depth discount, and dead‑lock early exit to produce a richer, depth‑aware reward signal.
```python
"""
