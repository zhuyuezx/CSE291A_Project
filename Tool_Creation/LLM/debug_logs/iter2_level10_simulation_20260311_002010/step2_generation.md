...
DESCRIPTION: Added a progress bonus for boxes on targets, increased step‑cost weight, widened reward range with a linear‑plus‑exponential blend, and applied a harsher penalty for dead‑locked states.
```python
import math
from typing import Any
