...
Timestamp:  2026-03-11T00:21:21.173306
Iterations: 500
Solved:     False
Steps:      10
Returns:    [0.0]
  ...
  Move 1: action=((2, 3), 2), total_visits=500
    ...
    Children: [((2, 3), 2)(v=497, avg=0.166), ((2, 3), 3)(v=1, avg=0.125), ((4, 3), 2)(v=1, avg=0.125), ((4, 3), 3)(v=1, avg=0.125)]
  Move 2: action=((4, 3), 2), total_visits=500
    State: Step 1/1000 | Boxes on target: 0/4 | Total distance: 7
    Children: [((2, 3), 3)(v=6, avg=0.143), ((4, 3), 2)(v=492, avg=0.167), ((4, 3), 3)(v=1, avg=0.143), ((3, 1), 0)(v=1, avg=0.143)]
  Move 3: action=((4, 3), 3), total_visits=500
    State: Step 13/1000 | Boxes on target: 0/4 | Total distance: 6
    Children: [((4, 3), 3)(v=255, avg=0.167), ((2, 3), 3)(v=245, avg=0.167)]
  Move 4: action=((5, 5), 0), total_visits=500
    State: Step 15/1000 | Boxes on target: 0/4 | Total distance: 5
    Children: []
  Move 5: action=((4, 5), 0), total_visits=500
    State: Step 18/1000 | Boxes on target: 0/4 | Total distance: 6
    Children: [((4, 5), 0)(v=500, avg=0.200)]
  Move 6: action=((3, 5), 0), total_visits=500
    State: Step 19/1000 | Boxes on target: 0/4 | Total distance: 5
    Children: [((3, 5), 0)(v=500, avg=0.200)]
  Move 7: action=((5, 1), 0), total_visits=500
    State: Step 20/1000 | Boxes on target: 1/4 | Total distance: 4
    Children: []
  Move 8: action=((2, 5), 2), total_visits=500
    State: Step 28/1000 | Boxes on target: 1/4 | Total distance: 5
    Children: []
  Move 9: action=((2, 2), 3), total_visits=500
    State: Step 35/1000 | Boxes on target: 1/4 | Total distance: 6
    Children: [((2, 4), 2)(v=15, avg=0.167), ((2, 2), 3)(v=485, avg=0.200)]
  Move 10: action=((2, 3), 3), total_visits=500
    State: Step 40/1000 | Boxes on target: 1/4 | Total distance: 5
    Children: [((2, 3), 3)(v=500, avg=0.200)]

Final state:
Step 41/1000 | Boxes on target: 1/4 | Total distance: 4
#######
#.   *#
#$  @$#
#$### #
...
Recent iterations:
  Iter 5 [level1] [simulation]: composite=1.0000, solve_rate=100%, desc=n/a ✗ rejected
