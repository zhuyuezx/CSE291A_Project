...
DESCRIPTION: added dead‑lock pruning, walk‑distance estimate, boxes‑on‑target progress term, and exponential scaling to give a richer, more discriminative reward signal.
```python
"""
A* heuristic evaluation — no rollout.
