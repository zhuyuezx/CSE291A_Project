...
Timestamp:  2026-03-11T15:47:24.418466
Iterations: 500
Solved:     True
Steps:      14
Returns:    [1.0]
  ...
  Move 1: action=((3, 4), 0), total_visits=500
    ...
    Children: [((3, 4), 0)(v=499, avg=0.503), ((3, 4), 2)(v=1, avg=0.000)]
  Move 2: action=((2, 4), 2), total_visits=500
    State: Step 1/1000 | Boxes on target: 1/4 | Total distance: 5
    Children: [((2, 4), 2)(v=497, avg=0.534), ((3, 4), 2)(v=1, avg=0.000), ((3, 2), 3)(v=1, avg=0.000), ((1, 5), 1)(v=1, avg=0.000)]
  Move 3: action=((2, 3), 1), total_visits=500
    State: Step 2/1000 | Boxes on target: 1/4 | Total distance: 5
    Children: [((2, 3), 1)(v=493, avg=0.507), ((1, 2), 1)(v=1, avg=0.000), ((3, 4), 2)(v=1, avg=0.000), ((2, 6), 2)(v=1, avg=0.000), ((2, 1), 3)(v=1, avg=0.000), ((3, 2), 3)(v=1, avg=0.000), ((4, 3), 0)(v=1, avg=0.000), ((1, 5), 1)(v=1, avg=0.000)]
  Move 4: action=((4, 4), 2), total_visits=500
    State: Step 3/1000 | Boxes on target: 2/4 | Total distance: 4
    Children: [((4, 4), 2)(v=495, avg=0.541), ((4, 2), 3)(v=1, avg=0.000), ((1, 2), 1)(v=1, avg=0.000), ((2, 6), 2)(v=1, avg=0.000), ((2, 1), 3)(v=1, avg=0.000), ((1, 5), 1)(v=1, avg=0.000)]
  Move 5: action=((1, 2), 1), total_visits=500
    State: Step 6/1000 | Boxes on target: 2/4 | Total distance: 4
    Children: [((1, 2), 1)(v=496, avg=0.576), ((4, 1), 3)(v=1, avg=0.000), ((2, 6), 2)(v=1, avg=0.000), ((2, 1), 3)(v=1, avg=0.000), ((1, 5), 1)(v=1, avg=0.000)]
  Move 6: action=((3, 1), 3), total_visits=500
    State: Step 11/1000 | Boxes on target: 2/4 | Total distance: 3
    Children: [((4, 1), 3)(v=1, avg=0.000), ((3, 1), 3)(v=497, avg=0.611), ((2, 6), 2)(v=1, avg=0.000), ((1, 5), 1)(v=1, avg=0.000)]
  Move 7: action=((2, 3), 1), total_visits=500
    State: Step 14/1000 | Boxes on target: 2/4 | Total distance: 3
    Children: [((2, 3), 1)(v=494, avg=0.653), ((3, 2), 3)(v=1, avg=0.000), ((4, 1), 3)(v=1, avg=0.000), ((3, 4), 2)(v=1, avg=0.000), ((2, 6), 2)(v=1, avg=0.000), ((4, 3), 0)(v=1, avg=0.000), ((1, 5), 1)(v=1, avg=0.000)]
  Move 8: action=((2, 6), 2), total_visits=500
    State: Step 17/1000 | Boxes on target: 3/4 | Total distance: 2
    Children: [((2, 6), 2)(v=499, avg=0.690), ((1, 5), 1)(v=1, avg=0.000)]
  Move 9: action=((2, 5), 2), total_visits=500
    State: Step 22/1000 | Boxes on target: 3/4 | Total distance: 1
    Children: [((2, 5), 2)(v=499, avg=0.730), ((2, 3), 3)(v=1, avg=0.000)]
  Move 10: action=((2, 4), 2), total_visits=500
    State: Step 23/1000 | Boxes on target: 3/4 | Total distance: 2
    Children: [((2, 4), 2)(v=498, avg=0.773), ((2, 2), 3)(v=1, avg=0.000), ((1, 3), 1)(v=1, avg=0.000)]
  Move 11: action=((1, 2), 1), total_visits=500
    State: Step 24/1000 | Boxes on target: 3/4 | Total distance: 2
    Children: [((1, 2), 1)(v=499, avg=0.817), ((2, 1), 3)(v=1, avg=0.000)]
  Move 12: action=((3, 1), 3), total_visits=500
    State: Step 27/1000 | Boxes on target: 3/4 | Total distance: 1
    Children: [((3, 1), 3)(v=500, avg=0.861)]
  Move 13: action=((3, 2), 3), total_visits=500
    State: Step 30/1000 | Boxes on target: 3/4 | Total distance: 1
    Children: [((3, 2), 3)(v=499, avg=0.910), ((3, 4), 2)(v=1, avg=0.000)]
  Move 14: action=((2, 4), 1), total_visits=500
    State: Step 31/1000 | Boxes on target: 3/4 | Total distance: 1
    Children: [((2, 4), 1)(v=497, avg=0.966), ((3, 3), 3)(v=1, avg=0.000), ((3, 5), 2)(v=1, avg=0.000), ((4, 4), 0)(v=1, avg=0.000)]

Final state:
Step 34/1000 | Boxes on target: 4/4 | Total distance: 0
########
#   *  #
#      #
#   @  #
